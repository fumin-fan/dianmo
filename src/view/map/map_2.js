...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(116.503308,39.920287);
    ...
    var markerArr = [{title:"点摩广告",content:"上海市静安区武宁南路488号智慧广场16F",point:"121.436893|31.240112",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ,{title:"点摩广告",content:"北京市朝阳区莱锦文化创意产业园CF11",point:"116.504736|39.919381",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    function addMarker(){
