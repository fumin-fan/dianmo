...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(104.069039,30.558242);
    ...
    var markerArr = [{title:"点摩广告",content:"上海市静安区武宁南路488号智慧广场16F",point:"121.436893|31.240112",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ,{title:"我的标记",content:"我的备注",point:"104.058675|30.556599",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ,{title:"点摩广告",content:"成都市高新区天府二街151号",point:"104.071482|30.557123",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    function addMarker(){
